...
with open('CSV_Phases.csv', 'r', newline='') as csvfile:
...
#edit each list item to needed        
        ...
        positionName.append("Phase$N" + Column[3] + "$N Phase")
        ...
        position0.append("Phase$N" + Column[3] + "$N .Abort")
        ...
        position1.append("Phase$N" + Column[3] + "$N .Aborted")
        ...
        position2.append("Phase$N" + Column[3] + "$N .Done")
        ...
        position3.append("Phase$N" + Column[3] + "$N .Held")
        ...
        position4.append("Phase$N" + Column[3] + "$N .Hold")
        ...
        position5.append("Phase$N" + Column[3] + "$N .InterLock")
        ...
        position6.append("Phase$N" + Column[3] + "$N .Ready")
        ...
        position7.append("Phase$N" + Column[3] + "$N .Reset")
        ...
        position8.append("Phase$N" + Column[3] + "$N .Restart")
        ...
        position9.append("Phase$N" + Column[3] + "$N .Run")
        ...
        position10.append("Phase$N" + Column[3] + "$N .Start")
        ...
        position11.append("Phase$N" + Column[3] + "$N .Complete")
        ...
        position12.append("Phase$N" + Column[3] + "$N .OutEnable1")
        ...
        position13.append("Phase$N" + Column[3] + "$N .OutEnable2")
        ...
        position14.append("Phase$N" + Column[3] + "$N .Pathmode/SoilRinse")
        ...
        position15.append("Phase$N" + Column[3] + "$N .CIPModifier")
        ...
        with open('CSV_EditedPhases.csv', 'a', newline='') as csvfiles:
